...
public class MachineRecipes {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(PartManager.getPartInfo("accelerator").getStack(), "OIO", "I I", "OIO", 'O',
                Blocks.obsidian, 'I', "ingotBlueSteel"));
        ...
        for (int i = 0; i < Refs.oreDictDyes.length; i++) {
            ...
            GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(BPItems.paint_can, 1, i), new ItemStack(Items.blaze_powder),
                    new ItemStack(Items.blaze_powder), Refs.oreDictDyes[i], new ItemStack(BPItems.paint_can, 1, 16)));
        }

        // Blocks
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BPBlocks.block_breaker, 1), "#A#", "#P#", "#R#", '#', "cobblestone", 'A',
                "itemPickWroughtIron", 'P', Blocks.piston, 'R', BPItems.red_doped_wafer));
