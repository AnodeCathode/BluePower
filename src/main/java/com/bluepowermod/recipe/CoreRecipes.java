...
//        GameRegistry.addSmelting(BPBlocks.silver_ore, new ItemStack(BPItems.silver_ingot), 0.7F);
    	for (ItemStack stack : OreDictionary.getOres("oreSatinspar")){
    		GameRegistry.addSmelting(stack, new ItemStack(BPItems.tungsten_nugget), 0.8F);	
    	}
    	

        //GameRegistry.addSmelting(Blocks.stone, new ItemStack(BPItems.stone_tile, 2), 0);
        //Oredictionary version for stone
...
//            GameRegistry.addRecipe(new ShapedOreRecipe(BPItems.amethyst_saw, "WSS", "WGS", 'W', "stickWood", 'S', "rodStone", 'G', BPItems.amethyst_gem));
//            GameRegistry.addRecipe(new ShapedOreRecipe(BPItems.ruby_saw, "WSS", "WGS", 'W', "stickWood", 'S', "rodStone", 'G', BPItems.ruby_gem));
//            GameRegistry.addRecipe(new ShapedOreRecipe(BPItems.sapphire_saw, "WSS", "WGS", 'W', "stickWood", 'S', "rodStone", 'G', BPItems.sapphire_gem));
        } else {
